				...
				<div>
    					...
    					<a href="?action=edit&category=inventory&facilityID={$request.id}&bookmark=inventory&tab=settings" {if $request.tab eq 'settings'}class="active_link" {/if}>Settings</a>
