...
{if $Products|@count > 0}  
    ...
    {/foreach} 
    <tr>
        <td colspan="{*if !$accessory}7{else}4{/if*}2" class="border_users_l border_users_r">
            &nbsp;
        </td>
    </tr>
    {*END LIST*}
{else}
    {*BEGIN	EMPTY LIST*}
    <tr>
        <td colspan="{*if !$accessory}7{else}4{/if*}2" class="border_users_l border_users_r" align="center">
