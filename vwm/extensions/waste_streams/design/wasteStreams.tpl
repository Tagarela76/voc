...
<script type="text/javascript">
	...
	var unitTypeClasses = new Array();
	{foreach from=$groupedUnitClasses key=i item=unitClass}
		unitTypeClasses[{$i}] = '{$unitClass->getName()}';
	{/foreach}
...
<script type="text/javascript" src="modules/js/wasteStreams.js?rev=feb01-1"></script>
