...
class XML2PDF extends PDF_MC_Table
{
	...
	function startElement($path) 
		...
		switch ($tag) 
		{
			...
			case 'PAGE':
			$this->SetWidths(array(50,35,35,35,35));
			...
			case 'EQUIPMENT':				
				...
				$this->rows[0] = 'PRODUCT ID';
				$this->rows[1] = 'CATEGORY';
				$this->rows[2] = 'AMOUNT USED (GAL)';
				$this->rows[3] = 'VOC OF COATING';
				$this->rows[4] = 'EXEMPT UNDER SECTION (C)';
	...
	function characterData( $tag, $attribs, $data, $path, $parentpath )
		...
		switch ($tag) {
			...
			case 'CONTACTNAME':
				$this->header['CONTACTNAME'] = $data;
				break;
				
			case 'TELNO':
				$this->header['TELNO'] = $data;								
				break;				
			...
			case 'PRINTNAME':				
				$this->footer['PRINTNAME'] = $data; 					
				break;
			
			case 'USERSTELNO':				
				$this->footer['USERSTELNO'] = $data; 					
				break;
				
			case 'DATE':				
				$this->footer['DATE'] = $data; 					
				break;						
		}
	...
	function Header( ) {		
    	...
    	if (isset($this->header['TITLE'])) {
	    	...
	    	$this->Cell(70,0,"Exempt Coatings Under Section: ",0,0,'R');
	    	$this->Cell(20,0,$this->header['SECTION'],0,0,'L');			
	    	$this->Ln(8);
	    	...
	    	$this->Line(200,20,200,50);
	    	$this->Line(10,50,200,50);
	    	
	    	$this->Cell(70,0,"Facility Name: ",0,0,'R');
	    	$this->Cell(20,0,$this->header['NAME'],0,0,'L');			
	    	$this->Ln(5);
	    	
	    	$this->Cell(70,0,"Location Address: ",0,0,'R');
	    	$this->Cell(20,0,$this->header['LOCATION'],0,0,'L');			
	    	$this->Ln(5);
	    	
	    	$this->Cell(70,0,"Contact Name: ",0,0,'R');
	    	$this->Cell(20,0,$this->header['CONTACTNAME'],0,0,'L');			
	    	$this->Ln(5);
	    	
	    	$this->Cell(70,0,"Tel No.: ",0,0,'R');
	    	$this->Cell(20,0,$this->header['TELNO'],0,0,'L');			
	    	$this->Ln(5);
	    	
	    	$this->Cell(70,0,"Facility ID No.: ",0,0,'R');
	    	$this->Cell(20,0,$this->header['ID'],0,0,'L');			
	    	$this->Ln(5);
	    	
	    	$this->Cell(70,0,"SCAQMD Permit No.: ",0,0,'R');
	    	$this->Cell(20,0,$this->header['PERMIT'],0,0,'L');			
	    	$this->Ln(5);
	    	
	    	$this->Line(10,50,10,84);
	    	$this->Line(200,50,200,84);
    	}
	...
	function Footer( )
		{
			if (isset($this->footer['PRINTNAME'])) {
				$this->SetY(-30);
				$this->Cell(50,0,"Prepared By:",0,0,'L');
				$this->Line(79,274,120,274);
				$this->Ln(5);
				
				
				$this->Cell(70,0,"Print Name",0,0,'R');
				$this->Cell(20,0,$this->footer['PRINTNAME'],0,0,'L');
				$this->Line(79,279,120,279);
				$this->Ln(5);
				
				$this->Cell(70,0,"Tel No.:",0,0,'R');
				$this->Cell(20,0,$this->footer['USERSTELNO'],0,0,'L');
				$this->Line(79,284,120,284);
				$this->Ln(5);
				
				$this->Cell(70,0,"Date:",0,0,'R');
				$this->Cell(20,0,$this->footer['DATE'],0,0,'L');
				$this->Ln(5);								
			}			
			$this->SetY(-15);												
			$this->SetX(-15);						
