    ...
    function startElement($path)
    {
        ...
        switch ($tag) {
            ...
            case 'TABLE':
                ...
                $this->Cell($this->widths[2], $h, "Static Pressure Reading", 1, 0, 'C');
                $this->Cell($this->widths[3], $h, "Inspected By", 1, 0, 'C');
    ...
    function endElement($path)
    {
        ...
        switch ($tag) {
            case 'LOGBOOKINSPECTION':
                ...
                $this->Cell($this->widths[2], $h, $attribs['READINGVALUE'], 1, 0, 'C');
                $this->Cell($this->widths[3], $h, $attribs['INSPECTEDPERSON'], 1, 0, 'C');
                $this->ln();
                break;
        }
    }
