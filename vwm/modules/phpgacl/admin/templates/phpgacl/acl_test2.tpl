{include file="tpls:phpgacl/header.tpl"} 
  </head>
<body>
{include file="tpls:phpgacl/navigation.tpl"}
<form method="post" name="acl_list" action="acl_list.php">
<table cellpadding="2" cellspacing="2" border="2" width="100%">
  <tr class="pager">
	<td colspan="11">
		{include file="tpls:phpgacl/pager.tpl" pager_data=$paging_data link="?"}
	</td>
  </tr>
  <tr>
    <th>#</th>
...
<br>
{include file="tpls:phpgacl/footer.tpl"}