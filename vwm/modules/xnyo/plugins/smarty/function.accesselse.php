 ...
 * File:        plugins/smarty/function.accesselse.php
 *              Access spliter, so the access plugin knows where to divide the content
 *
 * Website:	http://xnyo.odynia.org/
 * Manual:	http://xnyo.odynia.org/manual/
 *
 * Version:     3.0-dev
 * SVN Id:      $Id: function.accesselse.php 2 2004-07-06 19:49:11Z bok $
 * SVN URL:     $HeadURL: http://svn.odynia.org/xnyo/trunk/plugins/smarty/function.accesselse.php $
...
{
	echo "<::XNYO::ACCESS::FUNCTION::SPLIT>";
}
