function flotGraph(placeholder, legend_cont, data, tick, ylabel, xlabel, y_cont, x_cont) {
//   	var my_var = [];
            ...
            if (item) {
				...
				//	var year = date.getFullYear()
                    ...
                    showTooltip(item.pageX, item.pageY,
                                item.series.label + " of " + year + "-" + month + "-" + day + " = " + y);
                }
            }
            else {
                $("#tooltip").remove();
