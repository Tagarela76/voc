...
class EquipmentLightingColor {

	/**
	 *
	 * @var int 
	 */
	public $equipment_lighting_color_id;
	...
	function EquipmentLightingColor(db $db, $equipment_lighting_color_id = null) {
		$this->db = $db;
		
		if (isset($equipment_lighting_color_id)) {
			$this->equipment_lighting_color_id = $equipment_lighting_color_id;
			$this->_load();
		}
	}
	...
	private function _load() {
		...
		if (!isset($this->equipment_lighting_color_id)) {
			return false;
		}
		$sql = "SELECT * 
