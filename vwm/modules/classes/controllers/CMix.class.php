...
//$debug =true;
    ...
    protected function addEdit($action, $departmentID)
    {
        ...
        $customizedRuleList = $rule->getCustomizedRuleList($_SESSION['user_id'], $companyID, $department->getFacilityId(), $department->getDepartmentId());
    ...
    protected function prepareShowWasteForSmarty($isForm, $facilityID, $companyID, $mixID)
    {//shows that we can access madule Waste Streams
        $mWasteStreams = new MWasteStreams();
        $params = array(
            'db' => $this->db,
            'xnyo' => $this->xnyo,
