...
class ResourceTemplateTest extends DbTestCase {
	...
	public function testSave() {
		...
		//$resource->setLaborCost(10);
		//$resource->setMaterialCost(15);
		//$resource->setTotalCost(115);
		$resource->setRate(15);
		$resource->setRateUnittypeId(38);
		$resource->setRateQty(1);
		$resource->setStepTemplateId(1);
		...
		$this->assertEquals($resource->getStepTemplateId(), $row['step_template_id']);
		
		//test update
		$resourceUpdateTest = new ResourceTemplate($this->db, $id);
		$resourceUpdateTest->setDescription('new resource description');
		$resourceUpdateTest->setQty(200);
		$resourceUpdateTest->setUnittypeId(39);
		$resourceUpdateTest->setResourceTypeId(2);
		//$resourceUpdateTest->setLaborCost(20);
		//$resourceUpdateTest->setMaterialCost(30);
		//$resourceUpdateTest->setTotalCost(230);
		$resourceUpdateTest->setRate(30);
		$resourceUpdateTest->setRateUnittypeId(38);
		$resourceUpdateTest->setRateQty(2);
		$resourceUpdateTest->setStepTemplateId(2);
		...
		$this->assertEquals($resourceUpdateTest->getStepTemplateId(), $row['step_template_id']);
		$this->assertEquals($resourceUpdateTest->getMaterialCost()+$resourceUpdateTest->getLaborCost(), $row['total_cost']);
	}
