...
class ProductTest extends Testing\DbTestCase {
	...
	protected $fixtures = array(
		TB_COMPANY, TB_SUPPLIER, TB_PRODUCT, TB_PFP_TYPES, TB_PFP, TB_PFP2PRODUCT, TB_PFP2COMPANY, TB_PRODUCT_LIBRARY_TYPE, TB_PRODUCT2PRODUCT_LIBRARY_TYPE
	);
	...
	public function testAddProductLibraryTypes() {
		...
		$product->addProductLibraryTypes($productLibraryTypes, $productId);
