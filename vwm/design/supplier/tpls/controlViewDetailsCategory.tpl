...
{if $request.action != ""}
	...
	<input type="button" class="button" value="Edit" onclick="location.href='supplier.php?action=edit&category={$request.category}&id={$request.id}{if $request.subBookmark}&subBookmark={$request.subBookmark}{/if}{if $request.page }&page={$request.page}{/if}'">
	{/if}
