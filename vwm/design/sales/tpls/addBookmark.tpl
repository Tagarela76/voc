...
<form method='POST' action='sales.php?action={$request.action}&category=bookmarks&bookmark={$request.bookmark}{if $request.subBookmark}&subBookmark={$request.subBookmark}{*else}&subBookmark={$request.bookmark*}{/if}'>
