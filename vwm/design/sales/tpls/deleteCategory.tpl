...
<input type="button" value="No" class="button" onclick="location.href='sales.php?action=viewDetails&category={$request.category}{if $request.bookmark}&bookmark={$request.bookmark}{/if}{if $request.subBookmark}&subBookmark={$request.subBookmark}{/if}{if $request.letterpage}&letterpage={$request.letterpage}{/if}&id={$itemForDelete[0].id}'">
{else}
{if $flashback == "salescontacts"}
<input type="button" value="No" class="button" onclick="location.href='sales.php?action=browseCategory&category=salescontacts&bookmark={$request.bookmark}&subBookmark={$request.subBookmark}'"/>	
{else}
