...
<table class="" cellspacing="0" cellpadding="0" align="center" >
    ...
    <!--<form name="form" enctype="multipart/form-data" action="admin.php?action=browseCategoryPfpNew&category=bulkUploader" method="post">   -->
        ...
        <table>		
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="submit" value="Startpfp" name="pfp"/>
                    <input type="submit" value="StartGOM" name="gom"/>
                </td>
            </tr>
        </table>
