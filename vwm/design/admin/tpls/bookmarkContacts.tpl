...
{section name=i loop=$contacts}	
	<tr class="hov_company">
			...
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->id}</div ></a>
			</td>
			
            <td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->company}</div ></a>
			</td>
			
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->contact}</div ></a>
			</td>
			
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->phone}</div ></a>
			</td>
			...
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->fax}</div ></a>
			</td>
			...
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->industry}</div ></a>
			</td>
			
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->country_name}</div ></a>
			</td>
			
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->state_name}</div ></a>
			</td>
			
			<td class="border_users_b border_users_l" >
				<a href="{$contacts[i]->viewDetailsUrl}"><div style="width:100%;">{$contacts[i]->zip_code}</div ></a>
			</td>
