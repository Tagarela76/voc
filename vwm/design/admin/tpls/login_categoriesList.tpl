	...
	<tr>
		...
		<td  width="35%"valign="top" align="right">
			<div style="display:block;height:40%;width:300;" align="rignt">								
				<div  style="margin-right:10px;margin-top:15px;float:right;width:10%;" >
				  <span class="textbold " >
		...
		<td   class=" padd_bot10  " valign="top" width="5%">
			<div  class="margintop10" align="center">	<input type="button" class="button" value="VPS sync" onclick="location.href='?action=vps&vpsAction=sync'"> </div>			
