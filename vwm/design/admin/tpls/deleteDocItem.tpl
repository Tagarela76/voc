...
<div class="padd7">
	<form name="deleteDocItem" enctype="multipart/form-data"
		{if $step eq 'choose'}
			action="admin.php?action={$request.action}&category=salesdocs&salesDocsCategory={$request.salesDocsCategory}"
		{elseif $empty neq 'true'}
			action="admin.php?action=confirmDelete&category=salesdocs&salesDocsCategory={$request.salesDocsCategory}"
		{else}
			action="admin.php?action=browseCategory&category=salesdocs&salesDocsCategory={$request.salesDocsCategory}"
		{/if} method="POST">
		...
		<div align="right">
			<input type='button' name='cancel' class="button" value='Cancel'
				onClick="location.href='admin.php?action=browseCategory&category=salesdocs&salesDocsCategory={$request.salesDocsCategory}'">
			{if $step eq 'choose'}
