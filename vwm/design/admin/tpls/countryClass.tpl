...
{section name=i loop=$category}												
			<tr class="hov_company">
				<td class="border_users_l border_users_b">
 					<input type="checkbox"  value="{$category[i].country_id}" name="item_{$smarty.section.i.index}">
 				</td>
 				<td class="border_users_b border_users_l">
              		<a href="{$category[i].url}"><div style="width:100%;">{$category[i].country_id}</div ></a>
				</td>
...
{*BEGIN	EMPTY LIST*}
		<tr class="" align='center'>
			<td colspan="3" class="border_users_l border_users_r" >No countries</td>
		</tr>
{*END	EMPTY LIST*}
