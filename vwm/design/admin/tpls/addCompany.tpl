...
<script type="text/javascript">
	$(function() {
		...
		companyPage.companyId = {/literal} {$companyID} {literal};
	});
</script>
{/literal}
{if $color eq "green"}
            ...
            <tr>
				...
				<td class="border_users_l border_users_b border_users_r">
					<div align="left" style="float: left;">	
						<div id="industryTypesList">{$industryTypeList|escape} 
							{foreach from=$industryTypeId item="industryType"}
								<input type='hidden' name='industryType_id[]' id='industryType_id[]' value="{$industryType}" />
							{/foreach}	
						</div>
						<a href="#" onclick="companyPage.manageCompanies.openDialog();">edit</a>
					</div>												
				</td>
			</tr>
            <tr>
...
<div id="setCompanyToIndustryTypeContainer" title="set company to industry type" style="display:none;">Loading ...</div>