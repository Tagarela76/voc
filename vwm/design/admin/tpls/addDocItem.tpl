...
<div class="padd7">
	<form name="addDocItem" enctype="multipart/form-data" action="admin.php?action={$request.action}&category=salesdocs&salesDocsCategory={$request.salesDocsCategory}" method="POST">
