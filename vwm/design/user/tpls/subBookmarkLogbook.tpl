{if $request.category == "facility" and $request.bookmark == "logbook"}
    <div>
        {if $request.tab == "logbook" || !$request.tab}
            ...
            <a href="?action=browseCategory&category=facility&id={$request.id|escape}&bookmark=logbook&tab=logbook" >TODO</a>
        ...
        {elseif $request.tab == "inspectionPerson"}
            ...
            <a href="?action=browseCategory&category=facility&id={$request.id|escape}&bookmark=logbook&tab=logbookTODO" >TODO</a>
            <a href="?action=browseCategory&category=facility&id={$request.id|escape}&bookmark=logbook&tab=logbookRecurring">Recurring Logbook Record</a>
        ...
        {elseif $request.tab == "logbookTODO"}
            <a href="?action=browseCategory&category=facility&id={$request.id|escape}&bookmark=logbook&tab=logbook" >Logbook</a>
            <a href="?action=browseCategory&category=facility&id={$request.id|escape}&bookmark=logbook&tab=logbookTODO" class="active_link">TODO</a>
