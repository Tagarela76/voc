						...
						{section name=i loop=$equipmentFiltersList}		
							<tr id="filter_row_{$equipmentFiltersList[i]->equipment_filter_id}" class="border_users_l border_users_b">
								...
								<td> <input type='text' id='equipment_filter_name_{$equipmentFiltersList[i]->equipment_filter_id}' name='equipment_filter_name_{$equipmentFiltersList[i]->equipment_filter_id}' value='{$equipmentFiltersList[i]->name|escape}'>		
									{*ERORR*}
									<div id="error_eq_filter_name_{$equipmentFiltersList[i]->equipment_filter_id}" style="width:80px;margin:2px 0px 0px 5px; display:none;" align="left"><img src='design/user/img/alert1.gif' height=16  style="float:left;">
										<font style="float:left;vertical-align:bottom;color:red;margin:1px 0px 0px 5px;">Error!</font></div>
										{*/ERORR*}	
								</td>
								...
								<td><input type='text' id='equipment_filter_quantity_{$equipmentFiltersList[i]->equipment_filter_id}' name='equipment_filter_quantity_{$equipmentFiltersList[i]->equipment_filter_id}' value='{$equipmentFiltersList[i]->qty|escape}'>
									{*ERORR*}
									<div id="error_eq_filter_quantity_{$equipmentFiltersList[i]->equipment_filter_id}" style="width:80px;margin:2px 0px 0px 5px; display:none;" align="left"><img src='design/user/img/alert1.gif' height=16  style="float:left;">
										<font style="float:left;vertical-align:bottom;color:red;margin:1px 0px 0px 5px;">Error!</font></div>
										{*/ERORR*}
								</td>
							</tr>		
					...
					{if $equipmentLightingsList}
						{section name=i loop=$equipmentLightingsList}		
							<tr id="lighting_row_{$equipmentLightingsList[i]->equipment_lighting_id}" class="border_users_l border_users_b">
								...
								<td> <input type='text' id='equipment_lighting_name_{$equipmentLightingsList[i]->equipment_lighting_id}' name='equipment_lighting_name_{$equipmentLightingsList[i]->equipment_lighting_id}' value='{$equipmentLightingsList[i]->name|escape}'>
									{*ERORR*}
									<div id="error_eq_lighting_name_{$equipmentLightingsList[i]->equipment_lighting_id}" style="width:80px;margin:2px 0px 0px 5px; display:none;" align="left"><img src='design/user/img/alert1.gif' height=16  style="float:left;">
										<font style="float:left;vertical-align:bottom;color:red;margin:1px 0px 0px 5px;">Error!</font></div>
										{*/ERORR*}
								</td>
								...
								<td> <input type='text' id='equipment_lighting_size_{$equipmentLightingsList[i]->equipment_lighting_id}' name='equipment_lighting_size_{$equipmentLightingsList[i]->equipment_lighting_id}' value='{$equipmentLightingsList[i]->size|escape}'>
									{*ERORR*}
									<div id="error_eq_lighting_size_{$equipmentLightingsList[i]->equipment_lighting_id}" style="width:80px;margin:2px 0px 0px 5px; display:none;" align="left"><img src='design/user/img/alert1.gif' height=16  style="float:left;">
										<font style="float:left;vertical-align:bottom;color:red;margin:1px 0px 0px 5px;">Error!</font></div>
										{*/ERORR*}
								</td>
								<td> <input type='text' id='equipment_lighting_voltage_{$equipmentLightingsList[i]->equipment_lighting_id}' name='equipment_lighting_voltage_{$equipmentLightingsList[i]->equipment_lighting_id}' value='{$equipmentLightingsList[i]->voltage|escape}'>
									{*ERORR*}
									<div id="error_eq_lighting_voltage_{$equipmentLightingsList[i]->equipment_lighting_id}" style="width:80px;margin:2px 0px 0px 5px; display:none;" align="left"><img src='design/user/img/alert1.gif' height=16  style="float:left;">
										<font style="float:left;vertical-align:bottom;color:red;margin:1px 0px 0px 5px;">Error!</font></div>
										{*/ERORR*}
								</td>
								<td> <input type='text' id='equipment_lighting_wattage_{$equipmentLightingsList[i]->equipment_lighting_id}' name='equipment_lighting_wattage_{$equipmentLightingsList[i]->equipment_lighting_id}' value='{$equipmentLightingsList[i]->wattage|escape}'>
									{*ERORR*}

									<div id="error_eq_lighting_wattage_{$equipmentLightingsList[i]->equipment_lighting_id}" style="width:80px;margin:2px 0px 0px 5px; display:none;" align="left"><img src='design/user/img/alert1.gif' height=16  style="float:left;">
