						...
						{section name=i loop=$equipmentLightingsList}		
							<tr id="lighting_row_{$equipmentLightingsList[i]->equipment_lighting_id}" class="border_users_l border_users_b">
								...
								<td> <input type='text' id='equipment_lighting_wattage_{$equipmentLightingsList[i]->equipment_lighting_id}' name='equipment_lighting_wattage_{$equipmentLightingsList[i]->equipment_lighting_id}' value='{$equipmentLightingsList[i]->wattage|escape}'>
									{*ERORR*}
									<div id="error_eq_wattage_{$equipmentLightingsList[i]->equipment_lighting_id}" style="width:80px;margin:2px 0px 0px 5px; display:none;" align="left"><img src='design/user/img/alert1.gif' height=16  style="float:left;">
										<font style="float:left;vertical-align:bottom;color:red;margin:1px 0px 0px 5px;">Error!</font></div>
										{*/ERORR*}
								</td>
