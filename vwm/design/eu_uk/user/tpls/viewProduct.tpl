                ...
                <table class="mix_id" style="border-top:0px;" width="100%" cellpadding="0" cellspacing="0">
                   ...
                   {* <tr>
                    ...
                    <tr>
                        ...
                        <td class="border_users_l border_users_r border_users_b">
                            <div align="left">
                            	{if $product.density}
                                	&nbsp;{$product.density}&nbsp;																		
									{$unittype->getNameByID($product.density_unit->getNumerator())}/{$unittype->getNameByID($product.density_unit->getDenominator())}									
								{else}
									&nbsp;<i>empty</i>
								{/if}                                
                            </div>
                    ...
                    <tr>
                        ...
                        <td class="border_users_l border_users_r border_users_b">
                            <div align="left">&nbsp;
								{section name=i loop=$product.chemicalClasses}
									<b>{$product.chemicalClasses[i].name}:&nbsp;</b>
										{foreach from=$product.chemicalClasses[i].rules item=rule}
											{if $rule.rule_nr}
												{$rule.rule_nr};
											{/if} 
										{/foreach}
